#!/usr/bin/env python3
"""
MiCASA v2 — pipeline verification suite (run directly).

Runs ~60 structural-invariant, sign-convention, and cross-boundary sanity
checks over the pipeline output and prints a PASS/WARN/FAIL summary (it flags
any FAILs in the printout but does not set a non-zero exit code — same as the
former headless runner). Reads the working tree via env:

    WORK_DIR        the checkout / working dir (default: cwd)
    CARBONTRACKER   for the ERA5 meteo cross-checks

    cd $WORK_DIR && python3 tests/verify_v2.py

Some checks shell out to the R helpers in this dir (verify_p*_*.r) and to
NCO / Rscript on PATH. The plt.show() calls are no-ops under the headless Agg
backend set below (plots were only ever rendered in interactive Jupyter).

History: this was generated as verify_v2.ipynb by build_verify_v2.py and run
headless by run_verify_v2.py; collapsed to this single runnable script.
"""
import matplotlib
matplotlib.use("Agg")  # headless: no display, plt.show() is a no-op
...
MET_BASE_FALLBACK = Path(os.environ.get("CARBONTRACKER", "."))                         / "METEO/tm5-nc/ec/ea_0005/h06h18tr1/sfc/glb100x100"
...
# ======================================================================
# ## Section 2 — Pipeline Transformation Invariants
# ======================================================================
...
# ======================================================================
# ## Phase 2 Preflight — Build per-month summary cube
# ======================================================================
...
# ======================================================================
# ## Section 6 — Spatial Comparison vs v1 (where overlapping)
# ======================================================================
...
# ======================================================================
# ## Section 10 — NRT clim-fill / provisional-status consistency
# ======================================================================
...
# ======================================================================
# # Phase 4 — Numerical Edge Cases, Reproducibility, Point Validation, Known Events
# ======================================================================
...
# ======================================================================
# ## Section 14 — Canonical Biome Cell Validation
# ======================================================================
...
# ======================================================================
# # Phase 5 — Investigative Cells (Answer Open Science Questions)
# ======================================================================
...
# ======================================================================
# ## Section 20 — Cross-Product Comparison
# ======================================================================
